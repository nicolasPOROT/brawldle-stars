...
function createModeCard(cfg, options, index) {
  var href = cfg.href || "#";
  var onInfoClick =
    options && typeof options.onInfoClick === "function"
      ? options.onInfoClick
      : null;
...
var cardsData = [
  ...
  },
  {
    href: "classic.html",
    modeImage: "../assets/gamemode/classic_mode.png",
    labelImage: "../assets/gamemode/new.png",
    infoImage: "../assets/gamemode/gamemode_info_classic.png",
  },
  {
    href: "classic.html",
    modeImage: "../assets/gamemode/classic_mode.png",
    labelImage: "../assets/gamemode/trending.png",
    infoImage: "../assets/gamemode/gamemode_info_classic.png",
  },
  {
    href: "classic.html",
...
async function loadCardsData() {
  ...
  var modeIds = schedule.map(function (row) {
    return row.mode_id;
  });
  ...
  return schedule
    .map(function (row) {
      ...
      return {
        ...
        labelImage: labelName
          ? "../assets/gamemode/" + labelName + ".png"
          : null,
        infoText: mode.name,
